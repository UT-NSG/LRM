...
AggregatedAssesment = 
  ComparingMethodsCallerFunction(
    ...
    PowerSelector = 0.5, # Percent of power of eigenvalues to be used. Used by algegraic largest method. If powerselector has value, NumberOfLeadingEigenValues will be ignored. If number of eigenvalues is going to be specifically given, give NA as input for this arguement
    NumberOfLeadingEigenValues = 10, # if NA, all eigenvalues are used
    SelectorOfEigenValues = "LM" # common options include LA for algebraic largest, and LM for magnitude largest
    ) 

# Save an object to a file
# saveRDS(AggregatedAssesment, file = "AggregatedAssesment_Drosophila-Suppress-k=2.rds")
