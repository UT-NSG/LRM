...
write.table(Results_Matrix, 'SPM(Self)LRM(AUX)NormPCC_mean.txt', row.names = TRUE)
# proper naming scheme
# atl1_atl2_13981008_mean.txt
write.table(Results_Matrix_SD, 'SPM(Self)LRM(AUX)NormPCC_std.txt', row.names = TRUE)
# proper naming scheme
