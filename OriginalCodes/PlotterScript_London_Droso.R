...
assessment_11 = 
  readRDS(file = "AggregatedAssesment_LondonTransport-Tube-k=10-paper.rds")

assessment_12 = 
  readRDS(file = "AggregatedAssesment_Drosophila-Suppress-k=30-paper.rds")

# assessment_13 = 
#   readRDS(file = "AggregatedAssesment_Brain-Structure-k=20-paper.rds")
...
P12 = plot_lp_performance(assessment_12, metric = "auroc", err = "sd")
# P13 = plot_lp_performance(assessment_13, metric = "auroc", err = "sd")
...
P11 = P11 + ggtitle("LondonTransport/Tube \n K=10") +  theme(plot.title = element_text(hjust = 0.5))
P12 = P12 + ggtitle("Drosophila/Suppress \n K=30") +  theme(plot.title = element_text(hjust = 0.5))
# P13 = P13 + ggtitle("Brain/Structure \n K=20") +  theme(plot.title = element_text(hjust = 0.5))
