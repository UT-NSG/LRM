...
assessment_11 = 
  readRDS(file = "AggregatedAssesment_Brain-Structure-k=1-paper.rds")

assessment_12 = 
  readRDS(file = "AggregatedAssesment_Brain-Structure-k=5-paper.rds")
...
P12 = P12 + ggtitle("Brain/Structure \n K=5") +  theme(plot.title = element_text(hjust = 0.5))
