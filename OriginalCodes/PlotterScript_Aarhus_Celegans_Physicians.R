...
assessment_11 = 
  readRDS(file = "AggregatedAssesment_Aarhus-Lunch_by_All-k=10-paper.rds")

assessment_12 = 
  readRDS(file = "AggregatedAssesment_Celegans-Chem-poly-k=20-paper.rds")

assessment_13 = 
  readRDS(file = "AggregatedAssesment_Physicians-Advice-k=10-paper.rds")
...
P11 = P11 + ggtitle("CS-Aarhus/Lunch \n K=10") +  theme(plot.title = element_text(hjust = 0.5))
P12 = P12 + ggtitle("C. Elegans/Chem-poly \n K=20 \n") +  theme(plot.title = element_text(hjust = 0.5))
P13 = P13 + ggtitle("Physicians/Advice \n K=10 \n") +  theme(plot.title = element_text(hjust = 0.5))
