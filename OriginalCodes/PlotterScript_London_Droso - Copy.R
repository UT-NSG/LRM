...
assessment_11 = 
  readRDS(file = "AggregatedAssesment_Air-Train-Air-k=1-mirror-paper.rds")

assessment_12 = 
  readRDS(file = "AggregatedAssesment_Air-Train-Air-k=NA-mirror-paper.rds")
...
P11 = P11 + ggtitle("Air/Air Backup \n K=1") +  theme(plot.title = element_text(hjust = 0.5))
P12 = P12 + ggtitle("Air/Air Backup \n K=All") +  theme(plot.title = element_text(hjust = 0.5))
