           ...
           )
  {
    ...
    AUX_Pred =  tryCatch({
      while (k>0) {
        ...
        {
          AUX_Pred = Matrix::Matrix(0, N, N)
          print('Smart: Matrix is singular!');
          print('Reducing number of eigen values!');
          # reducing the k and trying again
          k = k - 1;
          print(paste("The new k is:", k))
          next
        }
    ...
    error = function(err) {
      ...
      print(paste("An error occured in LRM_SNE:  ",err))
    ...
    # # Debuggin
    print('I am here in end of Masked LRM Smart Number of Eigenvalues')
    return(AUX_Pred)
}